...
While the peer profile data provided by the admissions office is up-to-date, I use the 2019 gross and net price data from the DOE data set so I can compare it toe contemporaneous debt and forward earnings data.  These numbers are roughly 10% lower than for the 2122 school year.
...
The DOE data breaks out debt by family income cohort.  Denison stands out for graduating students with higher debt than most of our peers and is one of only two peer schools where students from low-income families graduate with debt higher than the average for the school overall.
...
Now let's aggregate the data by concentration and summarize into quartiles.  Denison concentrations are in the bottom quartile of earnings in several areas and in the top quartile in only one, History.  Oddly, none of our peer colleges show data in the Ethnic or Gender studies categories.
