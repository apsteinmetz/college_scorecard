...
## Comparing Denison to our Peer Colleges
...
subset_profiles %>%
  ...
  annotate(geom = "text",x = 20000,y=50000,label="Higher Value",size=5, color="darkgreen") +
  annotate(geom = "text",x = 35000,y=30000,label="Lower Value",size=5,color="red") +
